...
const experiences = [
  {
    ...
    responsibilities: [
      <>
        engineered a{" "}
        <span className="text-red-600 dark:text-red-400">ci/cd pipeline</span>{" "}
        for firmware builds to reduce build-to-test waiting by{" "}
        <span className="text-red-600 dark:text-red-400">5h/day</span>
      </>,
      <>
        developed automated sdk testing software for{" "}
  ...
  {
    company: "(uoft hacks) learn id",
    responsibilities: [
      <>
        ai-powered educational platform that personalizes learning content in
        real-time
      </>,
      <>
        based on learning style preferences derived from student behavior and
        engagement patterns.
      </>,
    ],
    techstack: ["python, google gemini, fastapi, mongodb"],
    githubUrl: "https://github.com/Romanabramovich/uoft-hacks-mercury",
  },

  {
    ...
    responsibilities: [
      <>
        a distributed logging platform processing{" "}
        <span className="text-red-600 dark:text-red-400">
          1,000+ logs/second
        </span>
      </>,
      <>
        with real-time web socket streaming for live log updates with{" "}
        <span className="text-red-600 dark:text-red-400">sub-100ms</span>{" "}
        latency and a web dashboard with{" "}
        <span className="text-red-600 dark:text-red-400">
...

  {
    ...
    responsibilities: [
      ...
      <>
        trained on{" "}
        <span className="text-red-600 dark:text-red-400">11,000+ games</span>{" "}
        and achieved{" "}
        <span className="text-red-600 dark:text-red-400">86% accuracy</span> on
        validation set
      </>,
    ],
...

  {
    ...
    responsibilities: [
      <>
        developed full-stack flask app parsing{" "}
        <span className="text-red-600 dark:text-red-400">
          real-time gtfs feeds
        </span>{" "}
        to visualize live positions and occupancy for{" "}
        <span className="text-red-600 dark:text-red-400">170+ ttc routes</span>
      </>,
      <>
        built interactive folium mapping system with dynamic route visualization
        and automated service disruption alerts
      </>,
    ],
...
export default function Page() {
  ...
  return (
    <div className="space-y-6">
      ...
      <hr
        className="w-full border-gray-200 dark:border-white-200 border-2.5 -mt-3"
                ...
                <div className="text-sm md:text-base xl:text-4sm 2xl:text-xl flex-1 min-w-0">
                  ...
                  {exp.techstack && (
                    <div className="mt-1 md:mt-0 md:inline">
                      <span className="text-xs md:text-sm lg:text-base xl:text-xs 2xl:text-lg text-gray-600 dark:text-gray-400">
                        {exp.techstack}
                      </span>
                    </div>
                  )}
                  ...
                  {exp.githubUrl && (
                    ...
                    >
                      <Image
                        ...
                        height={18}
                        alt="GitHub"
                        className="github-icon md:w-5 md:h-5"
                      />
                    </a>
                  )}
